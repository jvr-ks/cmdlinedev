...
readGuiParam(){
  ...
  global dpiCorrect, dpiScale, currentSelected, currentSelectedName
  
  ;currentSelected := iniReadSave("currentSelected", "gui", 0)
  
  currentSelectedName := iniReadSave("currentSelectedName", "gui", "")
...
;-------------------------------- readConfig --------------------------------
readConfig(){
  global configFile, menuHotkeyDefault, menuHotkey
