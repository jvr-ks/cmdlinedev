...
readConfig(){
  ...
  global fontDefault, font, fontsizeDefault, fontsize, emptyFiledSubstituteChar
...
rundev(){
  ...
  ; run, %comspec% /k %runnerPath%
  run, %runnerPath%
}
;-------------------------------- rundevSave --------------------------------
rundevSave(){
  global configFile, runnerPath
  
  ControlGetText, runnerPath, Edit1
