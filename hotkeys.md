...
**cmdlinedev** | \[ALT] + \[c]  | \[SHIFT] + \[ALT] + \[c] | \[ALT] + \[q], , \[ALT] + \[n], \[ALT] + \[f], \[ALT] + \[d], \[ALT] + \[k], \[ALT] + \[b], \[ALT] + \[o] and possible more FastSwitch hotkeys (fastSwitchCycleGroups) file "cldfastswitchhotkeys.txt"
...
**clipboardresize** \*2)| \[SHIFT] + \[WIN] + \[z] | \[SHIFT] + \[ALT] + \[WIN] + \[z] | \[ALT] + \[z]: Capture-area+Resize, \[WIN] + \[z]: Capture+Resize, \[CTRL] + \[WIN] + \[z]: C+R+Save, \[ALT] + \[WIN] + \[z]: Set size, \[WIN] + \[y]: OCR  
