...
;------------------------------- showGuiEvents -------------------------------
; showGuiEvents(){
  ; static AGuiControlEvent := "", AGuiEvent := "", AEventInfo := ""
  
  ; AGuiControlEvent .= A_GuiControlEvent . " "
  ; AGuiEvent .= A_GuiEvent . " " 
  ; AEventInfo .= A_EventInfo . " "

  ; s := "A_GuiControlEvent: " . AGuiControlEvent . "`n"
  ; s .= "A_GuiEvent: " . AGuiEvent . "`n"
  ; s .= "A_EventInfo: " . AEventInfo . "`n"
